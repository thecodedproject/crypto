// Code generated by "enumer -type=Exchange -trimprefix=Exchange -json -text -transform=snake"; DO NOT EDIT.
...
const _ExchangeName = "unknowndummy_exchangelunobinancesentinal"

var _ExchangeIndex = [...]uint8{0, 7, 21, 25, 32, 40}
...
var _ExchangeNameToValueMap = map[string]Exchange{
	_ExchangeName[0:7]:   0,
	_ExchangeName[7:21]:  1,
	_ExchangeName[21:25]: 2,
	_ExchangeName[25:32]: 3,
	_ExchangeName[32:40]: 4,
}
...
// MarshalText implements the encoding.TextMarshaler interface for Exchange
func (i Exchange) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for Exchange
func (i *Exchange) UnmarshalText(text []byte) error {
	var err error
	*i, err = ExchangeString(string(text))
	return err
}
